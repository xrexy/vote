...
/**
  ...
  *
  * @checksum - ab4c035acc29e371336f28628c8431c6fd6ab33f8a4b9bb61a6eda0b89c9ec03
  * @variables - radius=rounded,accentColor=green,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=800,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "color__inner": {
    ...
    "dark:group-data-[prefix-icon]:border-gray-800": true,
    "dark:group-data-[suffix-icon]:border-gray-800": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "dark:group-data-[multiple]:border-gray-700": true,
  ...
  "slider__minValue": {
    ...
    "dark:[&>div>div::after]:bg-gray-800": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=\"tab\"]/wrapper:border-gray-800": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:before:border-gray-800": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:after:bg-gray-800": true,
